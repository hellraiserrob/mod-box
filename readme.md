...
- Scope your rules to specific domains and url criteria
- Organise your rules by a folder and tab structure, which could be used by project (folder) and then environment (tab)
