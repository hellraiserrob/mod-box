    ...
    <div class="panel">
      ...
      <table class="table" v-if="tab.requestHeaders.length">
        <tr>
          ...
          <th>Header value</th>
          <th>
            <a href="https://developer.chrome.com/docs/extensions/reference/api/declarativeNetRequest#filter-matching-charactgers" target="_blank">
              Url Filter
            </a>
          </th>
          <th>
            <a href="https://developer.chrome.com/docs/extensions/reference/api/declarativeNetRequest#type-RuleCondition" target="_blank">
              Domains 
            </a>
          </th>
          <th></th>
